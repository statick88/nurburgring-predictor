...
const RACE_DURATION_SECONDS = 24 * 60 * 60; // 24 horas en segundos
...
export default function Header() {
  ...
  // Race started at 12:00, now is ~17:50, so ~17h49m elapsed, ~6h10m remaining
  useEffect(() => {
    setElapsedSeconds(17 * 3600 + 49 * 60); // ~17:49:00 elapsed, ~6:10:57 remaining
